...
def loading(a):
    ...
    for i in range(0,2):
        ...
        # for j in text2:
        #     print(j.strip())
        with open('luhan.txt', 'a', encoding='utf-8') as w:
            w.write(j+'\n')

    return 123

import requests as r
url='https://weibo.com/p/1006051259110474/home'
cookies={'SUB':'_2A25xGDBrDeRhGeNJ61MW8inOzz2IHXVSbCajrDV8PUNbmtAKLRihkW9NSB4Mp4hCwtKCch8JSAFXYtD-sVDgKSU6'}
data='''pids: Pl_Official_MyProfileFeed__24
is_search: 0
visible: 0
is_all: 1
is_tag: 0
...
id: 1006051259110474
script_uri: /p/1006051259110474/home
feed_type: 0
page: 1
pre_page: 1'''
